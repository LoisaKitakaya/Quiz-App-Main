...
export const getSuccessMessage = (status) => {
  switch (status) {
    ...
    case 208:
      return "Already Reported: The members of a DAV binding have already been enumerated in a preceding part of the (multistatus) response, and are not being included again.";
    case 226:
